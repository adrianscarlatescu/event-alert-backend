...
insert into user(id, email, first_name, last_name, date_of_birth, gender, image_path, phone_number, join_date_time)
  values (1, "test1@test.com", "Alan", "Walter", "1984-05-23", "MALE", "img/user_1.jpg", "+03442777999", now());
insert into user(id, email, first_name, last_name, date_of_birth, gender, image_path, phone_number, join_date_time)
  values (2, "test2@test.com", "John", "Smith", "1987-10-16", "MALE", "img/user_2.jpg", "+44627779991", now());
insert into user(id, email, first_name, last_name, date_of_birth, gender, image_path, phone_number, join_date_time)
  values (3, "test3@test.com", "Cindy", "Milner", "1990-09-27", "FEMALE", "img/user_3.jpg", "+44848992441", now());
insert into user(id, email, first_name, last_name, date_of_birth, gender, image_path, phone_number, join_date_time)
  values (4, "test4@test.com", "Andrew", "Carter", "1992-02-14", "MALE", "img/user_4.jpg", "+44226812612", now());
insert into user(id, email, first_name, last_name, date_of_birth, gender, image_path, phone_number, join_date_time)
  values (5, "test5@test.com", "Amy", "Patterson", "1991-06-12", "FEMALE", "img/user_5.jpg", "+44226812555", now());
...
insert into tag(id,name,image_path) values(1,"Other",null);
insert into tag(id,name,image_path) values(2,"Fire","img/tag_fire.png");
insert into tag(id,name,image_path) values(3,"Flood","img/tag_flood.png");
insert into tag(id,name,image_path) values(4,"Earthquake","img/tag_earthquake.png");
insert into tag(id,name,image_path) values(5,"Landslide","img/tag_landslide.png");
insert into tag(id,name,image_path) values(6,"Storm","img/tag_storm.png");
insert into tag(id,name,image_path) values(7,"Heavy rain","img/tag_heavy_rain.png");
insert into tag(id,name,image_path) values(8,"Snow abundance","img/tag_intense_snow.png");
insert into tag(id,name,image_path) values(9,"Hurricane","img/tag_hurricane.png");
insert into tag(id,name,image_path) values(10,"Volcanic eruption","img/tag_volcanic_erruption.png");
insert into tag(id,name,image_path) values(11,"Tsunami","img/tag_tsunami.png");
insert into tag(id,name,image_path) values(12,"Dense fog","img/tag_fog.png");
insert into tag(id,name,image_path) values(13,"Avalanche","img/tag_avalanche.png");
insert into tag(id,name,image_path) values(14,"Ground hole","img/tag_ground_hole.png");
insert into tag(id,name,image_path) values(15,"High temperature","img/tag_high_temperature.png");
insert into tag(id,name,image_path) values(16,"Low temperature","img/tag_low_temperature.png");
insert into tag(id,name,image_path) values(17,"Fight","img/tag_fight.png");
insert into tag(id,name,image_path) values(18,"Murder","img/tag_murder.png");
insert into tag(id,name,image_path) values(19,"Protest","img/tag_protest.png");
insert into tag(id,name,image_path) values(20,"Traffic accident","img/tag_traffic_accident.png");
insert into tag(id,name,image_path) values(21,"Industrial accident","img/tag_industrial_accident.png");
insert into tag(id,name,image_path) values(22,"Dangerous animal","img/tag_dangerous_animal.png");
insert into tag(id,name,image_path) values(23,"Explosion","img/tag_explosion.png");
insert into tag(id,name,image_path) values(24,"Dangerous building","img/tag_dangerous_building.png");
insert into tag(id,name,image_path) values(25,"Electrical shock","img/tag_electrical_shock.png");
insert into tag(id,name,image_path) values(26,"Intense pollution","img/tag_intense_pollution.png");
insert into tag(id,name,image_path) values(27,"Blocked road","img/tag_blocked_road.png");
insert into tag(id,name,image_path) values(28,"Vandalism","img/tag_vandalism.png");
insert into tag(id,name,image_path) values(29,"Nuclear radiation","img/tag_nuclear_radiation.png");
insert into tag(id,name,image_path) values(30,"Gunfire","img/tag_gunfire.png");

insert into severity(id,name,image_path) values(1,"Critical",16711680);
insert into severity(id,name,image_path) values(2,"Major",16745779);
insert into severity(id,name,image_path) values(3,"Minor",16762980);
insert into severity(id,name,image_path) values(4,"Trivial",11192420);

insert into event(id, date_time, image_path, latitude, longitude, severity_id, tag_id, user_id, description)
...
insert into event(id, date_time, image_path, latitude, longitude, severity_id, tag_id, user_id, description)
	values(31, "2020-05-02 18:52:09", "img/event_31.jpg", 25.2640939, 63.4767481, 11, 1, 3, null);
insert into event(id, date_time, image_path, latitude, longitude, severity_id, tag_id, user_id, description)
...
insert into comment(date_time, event_id, user_id, comment)
  values("2020-04-10 18:44:02", 2, 3, "I've seen that the fire passed and only one person got hurt. I will try to get in contact with someone out there.");
insert into comment(date_time, event_id, user_id, comment)
  values("2020-04-10 19:23:33", 2, 4, "Thanks a lot. Let us know what you've found out.");
insert into comment(date_time, event_id, user_id, comment)
  values("2020-04-10 20:22:46", 2, 3, "It seems that everything is back to normal. The person that got hurt is safe now.");
insert into comment(date_time, event_id, user_id, comment)
...
insert into comment(date_time, event_id, user_id, comment)
  values("2020-04-12 11:25:02", 6, 1, "The water level is not so high. Each person is safe and no one got hurt. I think this bad weather will pass soon. Such a climate change is not usual in the region of Porto.");
insert into comment(date_time, event_id, user_id, comment)
  values("2020-04-15 12:38:55", 15, 5, "How is it possible to snow in Sahara? Lol.");
insert into comment(date_time, event_id, user_id, comment)
  values("2020-04-15 14:15:11", 15, 4, "Why do you laugh? I think it happened before too. Anyway, it's a unique phenomenon.");
insert into comment(date_time, event_id, user_id, comment)
