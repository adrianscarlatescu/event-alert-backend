...
values
    ...
    (3, '2020-04-10 14:23:55', 'media/event/event_3.jpg', 44.3196758, 27.2105093, 10, 'EXTREME', 'HURRICANE', 'RECOVERY', 3),
    ...
    (17, '2020-04-16 04:06:52', 'media/event/event_17.jpg', 44.4526384, 26.0858512, 5, 'TRIVIAL', 'PROTEST_RIOT', 'ACTIVE_ONGOING', 1),
    ...
    (21, '2020-04-18 15:17:16', 'media/event/event_21.jpg', 44.84557, 24.8882765, null, 'TRIVIAL', 'INFRASTRUCTURE_DAMAGE', 'CLOSED', 1),
    (22, '2020-04-18 20:18:42', 'media/event/event_22.jpg', 44.4783304, 26.1058571, null, 'TRIVIAL', 'LOW_TEMPERATURE', 'CLOSED', 1),
    (23, '2020-04-23 19:21:27', 'media/event/event_23.jpg', 44.7120456, 26.1712108, 100, 'EXTREME', 'WILDFIRE', 'ACTIVE_ONGOING', 1),
    (24, '2020-04-23 22:02:43', 'media/event/event_24.jpg', 44.6685877, 24.8795494, null, 'TRIVIAL', 'LOW_TEMPERATURE', 'CLOSED', 2),
    (25, '2020-04-24 17:01:46', 'media/event/event_25.jpg', 44.3971708, 26.0570636, 0, 'MAJOR', 'FIGHT_ASSAULT', 'ACTIVE_ONGOING', 2),
    (26, '2020-05-01 13:01:22', 'media/event/event_26.jpg', 39.0595653, 21.8750569, 1, 'MAJOR', 'FIRE', 'ACTIVE_ONGOING', 3),
    (27, '2020-05-01 14:16:02', 'media/event/event_27.jpg', 57.494195, -4.2122708, 10, 'TRIVIAL', 'STORM', 'RECOVERY', 3),
...
values
    ...
    (3, '2020-04-10 19:23:33', 2, 4, 'Thanks a lot. Let us know what you''ve found out.'),
    (4, '2020-04-10 20:22:46', 2, 3, 'It seems that everything is back to normal. The person that got hurt is safe now.'),
    (5, '2020-04-10 20:50:17', 2, 1, 'The fire has been extinguished and everyone is OK :)'),
    (6, '2020-04-12 10:11:52', 6, 3, 'Such a bad weather in Portugal... Is everyone OK?'),
    (7, '2020-04-12 11:25:02', 6, 1, 'The water level is not so high. Each person is safe and no one got hurt. I think this bad weather will pass soon. Such a climate change is not usual in the region of Porto.'),
    (8, '2020-04-15 12:38:55', 15, 5, 'How is it possible to snow in Sahara? Lol.'),
    (9, '2020-04-15 14:15:11', 15, 4, 'Why do you laugh? I think it happened before too. Anyway, it''s a unique phenomenon.'),
