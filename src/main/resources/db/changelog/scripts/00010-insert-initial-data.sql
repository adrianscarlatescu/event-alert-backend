...
values
    (1, 1, 'BLOCKED_ROAD', 'Blocked road', 'media/type/type_blocked_road.png'),
    (2, 1, 'DRUG_ACTIVITY', 'Drug activity', 'media/type/type_drug_activity.png'),
    (3, 1, 'ELECTRICAL_SHOCK', 'Electrical shock', 'media/type/type_electrical_shock.png'),
    (4, 1, 'EXPLOSION', 'Explosion', 'media/type/type_explosion.png'),
    (5, 1, 'FIGHT_ASSAULT', 'Fight/Assault', 'media/type/type_fight_assault.png'),
    (6, 1, 'FIRE', 'Fire', 'media/type/type_fire.png'),
    (7, 1, 'GAS_LEAK', 'Gas leak', 'media/type/type_gas_leak.png'),
    (8, 1, 'GUNFIRE', 'Gunfire', 'media/type/type_gunfire.png'),
    (9, 1, 'INDUSTRIAL_ACCIDENT', 'Industrial accident', 'media/type/type_industrial_accident.png'),
    (10, 1, 'INFRASTRUCTURE_DAMAGE', 'Infrastructure damage', 'media/type/type_infrastructure_damage.png'),
    (11, 1, 'KIDNAPPING', 'Kidnapping', 'media/type/type_kidnapping.png'),
    (12, 1, 'MISSING_PERSON', 'Missing person', 'media/type/type_missing_person.png'),
    (13, 1, 'MURDER_CRIME', 'Murder/Crime', 'media/type/type_murder_crime.png'),
    (14, 1, 'NUCLEAR_RADIATION', 'Nuclear radiation', 'media/type/type_nuclear_radiation.png'),
    (15, 1, 'POLLUTION', 'Pollution', 'media/type/type_pollution.png'),
    (16, 1, 'POWER_OUTAGE', 'Power outage', 'media/type/type_power_outage.png'),
    (17, 1, 'PROTEST_RIOT', 'Protest/Riot', 'media/type/type_protest_riot.png'),
    (18, 1, 'ROBBERY_BURGLARY', 'Robbery/Burglary', 'media/type/type_robbery_burglary.png'),
    (19, 1, 'TERRORIST_ATTACK', 'Terrorist attack', 'media/type/type_terrorist_attack.png'),
    (20, 1, 'TRAFFIC_ACCIDENT', 'Traffic accident', 'media/type/type_traffic_accident.png'),
    (21, 1, 'VANDALISM', 'Vandalism', 'media/type/type_vandalism.png'),

    (22, 2, 'AVALANCHE', 'Avalanche', 'media/type/type_avalanche.png'),
    (23, 2, 'DANGEROUS_ANIMAL', 'Dangerous animal', 'media/type/type_dangerous_animal.png'),
    (24, 2, 'DROUGHT', 'Drought', 'media/type/type_drought.png'),
    (25, 2, 'EARTHQUAKE', 'Earthquake', 'media/type/type_earthquake.png'),
    (26, 2, 'FLOOD', 'Flood', 'media/type/type_flood.png'),
    (27, 2, 'FOG', 'Fog', 'media/type/type_fog.png'),
    (28, 2, 'HIGH_TEMPERATURE', 'High temperature', 'media/type/type_high_temperature.png'),
    (29, 2, 'HURRICANE', 'Hurricane', 'media/type/type_hurricane.png'),
    (30, 2, 'LANDSLIDE', 'Landslide', 'media/type/type_landslide.png'),
    (31, 2, 'LOW_TEMPERATURE', 'Low temperature', 'media/type/type_low_temperature.png'),
    (32, 2, 'RAIN', 'Rain', 'media/type/type_rain.png'),
    (33, 2, 'SINKHOLE', 'Sinkhole', 'media/type/type_sinkhole.png'),
    (34, 2, 'SNOW', 'Snow', 'media/type/type_snow.png'),
    (35, 2, 'STORM', 'Storm', 'media/type/type_storm.png'),
    (36, 2, 'TSUNAMI', 'Tsunami', 'media/type/type_tsunami.png'),
    (37, 2, 'VOLCANIC_ERUPTION', 'Volcanic eruption', 'media/type/type_volcanic_eruption.png'),
    (38, 2, 'WILDFIRE', 'Wildfire', 'media/type/type_wildfire.png'),

    (39, 3, 'OTHER', 'Other', 'media/type/type_other.png');
